...
const EditPlaylistModal = ({
  ...
  }, [open, name, description, isPublic]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#282828] border-none text-white max-w-[524px] p-6 gap-0 [&>button]:hidden">
        ...
        <div className="flex gap-4 mb-4">
          {/* Cover placeholder */}
          <div className="size-[180px] shrink-0 rounded bg-[#3e3e3e] flex items-center justify-center shadow-lg">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex-1">
              ...
              <textarea
                ...
                className="w-full h-[100px] bg-[#3e3e3e] text-white text-sm placeholder:text-[#b3b3b3] rounded-md px-3 py-2 resize-none focus:outline-none focus:ring-1 focus:ring-white"
              />
            </div>
          </div>
        </div>
